...
export function ReplayViewer({ onNavigateLanding }: { onNavigateLanding?: () => void }) {
  const {
    events,
    isLoading,
    error,
  ...
  return (
    <div className="h-screen w-screen flex flex-col bg-chassis text-argent overflow-hidden select-none font-sans relative">
      <SentinelBackdrop mode="replay" />
